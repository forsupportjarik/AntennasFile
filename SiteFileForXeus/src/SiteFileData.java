...
public class SiteFileData {
    ...
    public static void writeDataToXeusFile(File file) throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
        ...
        ResultSet rs = stmt.executeQuery("SELECT mentor.NodeB_name, mentor.CellNameOSS, mentor.Lontitude, mentor.Latitude, mentor.Azimuth,\n" +
                "zte_UUtranCellFDD.refULocationArea, zte_UUtranCellFDD.cId, zte_UUtranCellFDD.uarfcnDl,\n" +
                "zte_UUtranCellFDD.primaryScramblingCode, zte_UUtranCellFDD.primaryCpichPower\n" +
                "FROM mentor, zte_UUtranCellFDD WHERE mentor.CellNameOSS = zte_UUtranCellFDD.userLabel");
