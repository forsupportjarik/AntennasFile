...
public class SiteFileDataNokia {
    ...
    public static void writeDataToXeusFileNokia(File file) throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
        ...
        ResultSet rs = stmt.executeQuery("SELECT mentor.BSC_RNC_OSS, mentor.NodeB_name, mentor.CellNameOSS, mentor.Lontitude, mentor.Latitude, mentor.Azimuth,\n" +
                "nsn_rnc_WCEL.LAC, nsn_rnc_WCEL.CId, nsn_rnc_WCEL.UARFCN,\n" +
                "nsn_rnc_WCEL.PriScrCode, nsn_rnc_WCEL.PtxPrimaryCPICH\n" +
                "FROM mentor, nsn_rnc_WCEL WHERE mentor.CellNameOSS = nsn_rnc_WCEL.name");
