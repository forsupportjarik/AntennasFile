...
public class SiteFileDataHuawei {

    public static void writeDataToXeusFileHuawei(File file) throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException, SQLException {
        ...
        ResultSet rs = stmt.executeQuery("SELECT mentor.BSC_RNC_OSS, mentor.NodeB_name, UMTS_ADD_UCELLSETUP.CELLNAME, mentor.Lontitude, mentor.Latitude, mentor.Azimuth,\n" +
                "CONV(SUBSTRING(UMTS_ADD_UCELLSETUP.LAC, 3), 16, 10), UMTS_ADD_UCELLSETUP.CELLID, UMTS_ADD_UCELLSETUP.UARFCNDOWNLINK,\n" +
                "UMTS_ADD_UCELLSETUP.PSCRAMBCODE, UMTS_ADD_UCELLSETUP.MAXTXPOWER/10\n" +
                "FROM mentor, UMTS_ADD_UCELLSETUP WHERE CONCAT(mentor.LAC_RPDB,mentor.CellID_RPDB) = CONCAT(CONV(SUBSTRING(UMTS_ADD_UCELLSETUP.LAC, 3), 16, 10), UMTS_ADD_UCELLSETUP.CELLID)");
        ...
        System.out.println("SiteFileForXeusHuawei.xif file is done.");
    }
}
